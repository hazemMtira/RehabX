...
/// Attach to a persistent GameObject in your Game scene.
/// Flow:
...
public class SupabaseManager : MonoBehaviour
{
    ...
    IEnumerator FetchPendingSession()
    {
        ...
        // Parse array — Unity doesn't support array root, wrap it
    ...
    void LoadSessionIntoSettings(SessionData s)
{
    ...
    {
        StartCoroutine(PatchSession(sessionId, "{\"session_status\":\"active\",\"start_time\":\"" + DateTime.UtcNow.ToString("o") + "\"}", onDone));
    }
